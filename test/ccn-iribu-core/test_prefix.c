...
int main(void)
{
    const UnitTest tests[] = {
        unit_test(test_prefix_to_path),          unit_test(test_uri_to_prefix),
        unit_test(test_append_to_prefix),        unit_test(test_prefix_exact_match),
        unit_test(test_prefix_no_exact_match),   unit_test(test_prefix_longest_match),
