...
#    define CCN_IRIBU_DTAG_FRAG2012_SEQNR \
        (CCN_IRIBU_DTAG_FRAGMENT2012 + 3)    // our seq number

#    define CCN_IRIBU_DTAG_FRAG2012_OLOSS \
        (CCN_IRIBU_DTAG_FRAGMENT2012 + 5)    // our loss count
#    define CCN_IRIBU_DTAG_FRAG2012_YSEQN \
        (CCN_IRIBU_DTAG_FRAGMENT2012 + 6)    // your (highest) seq no

// fragmentation protocol: (ccn-iribu-ext-frag.c, FRAG_CCNx2013)
#    define CCN_IRIBU_DTAG_FRAGMENT2013 \
        CCN_DTAG_FragP    // requested 2013-07-24, assigned 2013-08-12
...
#    define CCN_IRIBU_DTAG_FRAG2013_OLOSS \
        CCN_IRIBU_DTAG_FRAG2012_OLOSS    // our loss count
#    define CCN_IRIBU_DTAG_FRAG2013_YSEQN \
        CCN_IRIBU_DTAG_FRAG2012_YSEQN    // your (highest) seq no
