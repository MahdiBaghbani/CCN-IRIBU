...
*/
void 
ccn_iribu_prefix_free(struct ccn_iribu_prefix_s *prefix);
...
*/
int8_t
ccn_iribu_prefix_appendCmp(struct ccn_iribu_prefix_s *prefix, uint8_t *cmp, size_t cmplen);
...
*/
   char* ccn_iribu_prefix_to_path_detailed(struct ccn_iribu_prefix_s *pr, int ccntlv_skip, int escape_components, int call_slash);
#  define ccn_iribu_prefix_to_path(P) ccn_iribu_prefix_to_path_detailed(P, 1, 0, 0)
#  define ccn_iribu_prefix_to_str(P, buf, buflen) ccn_iribu_prefix_to_str_detailed(P, 1, 0, 0, buf, buflen)
#else
/**
