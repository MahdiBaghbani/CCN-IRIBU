...
#        ifdef CCN_IRIBU_ARDUINO
void *debug_malloc(size_t num, size_t size, const char *fn, int lno, double tstamp);
void *debug_calloc(size_t num, size_t size, const char *fn, int lno, double tstamp);
void *debug_strdup(const char *s, const char *fn, int lno, double tstamp);

#            define ccn_iribu_malloc(s) \
                debug_malloc(s, PSTR(__FILE__), __LINE__, CCN_IRIBU_NOW())
#            define ccn_iribu_calloc(n, s) \
                debug_calloc(n, s, PSTR(__FILE__), __LINE__, CCN_IRIBU_NOW())
#            define ccn_iribu_realloc(p, s) debug_realloc(p, s, PSTR(__FILE__), __LINE__)
#            define ccn_iribu_strdup(s) \
                debug_strdup(s, PSTR(__FILE__), __LINE__, CCN_IRIBU_NOW())
#            define ccn_iribu_free(p) debug_free(p, PSTR(__FILE__), __LINE__)

#        else
void *debug_malloc(size_t s, const char *fn, int lno, char *tstamp);
void *debug_calloc(size_t num, size_t size, const char *fn, int lno, char *tstamp);
...
#            define ccn_iribu_calloc(n, s) \
                debug_calloc(n, s, __FILE__, __LINE__, timestamp())
...
/**
 * @brief Allocates a block of size bytes of memory, returning a pointer to the beginning
 * of the block.
 *
