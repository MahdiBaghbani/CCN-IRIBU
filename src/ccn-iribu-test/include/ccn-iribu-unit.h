...
int RUN_TEST(int testnum, char *description, int (*prepare)(void **testdata, void **comp),
             int (*run)(void *testdata, void *comp),
             int (*cleanup)(void *testdata, void *comp), void *testdata, void *comp)
{
