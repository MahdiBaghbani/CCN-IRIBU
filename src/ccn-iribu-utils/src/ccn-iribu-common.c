...
#ifndef CCN_IRIBU_UAPI_H_    // if CCN_IRIBU_UAPI_H_ is defined then the following config
                             // is taken care elsewhere in the code composite
...
int ccn_iribu_parseUdp(char *udp, int suite, char **addr, int *port)
{
    char *tmpAddr    = NULL;
