...
int mkInterestCompute(char **namecomp, char *computation, int computationlen, char *out)
{
#ifndef USE_UTIL
    ...
    len +=
        mkBlob(out + len, CCN_DTAG_COMPONENT, CCN_TT_DTAG, computation, computationlen);
