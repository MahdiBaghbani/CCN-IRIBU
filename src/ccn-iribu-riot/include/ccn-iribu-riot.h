 ...
 */
int ccn_iribu_send_interest(struct ccn_iribu_prefix_s *prefix,
 ...
 */
static inline struct ccn_iribu_content_s *ccn_iribu_msg_cs_lookup(struct ccn_iribu_prefix_s *prefix)
{
 ...
 */
static inline void ccn_iribu_evtimer_reset_interest_retrans(struct ccn_iribu_interest_s *i)
{
    evtimer_del((evtimer_t *)(&ccn_iribu_evtimer), (evtimer_event_t *)&i->evtmsg_retrans);
 ...
 * @param[in] i         The interest to update
 */
static inline void ccn_iribu_evtimer_reset_interest_timeout(struct ccn_iribu_interest_s *i)
{
    evtimer_del((evtimer_t *)(&ccn_iribu_evtimer), (evtimer_event_t *)&i->evtmsg_timeout);
...
{
    evtimer_del((evtimer_t *)(&ccn_iribu_evtimer), (evtimer_event_t *)&f->evtmsg_timeout);
    f->evtmsg_timeout.msg.type = CCN_IRIBU_MSG_FACE_TIMEOUT;
    f->evtmsg_timeout.msg.content.ptr = f;
    ((evtimer_event_t *)&f->evtmsg_timeout)->offset = CCN_IRIBU_FACE_TIMEOUT * 1000; // ms
...
static inline void ccn_iribu_evtimer_set_cs_timeout(struct ccn_iribu_content_s *c)
{
    ...
    ((evtimer_event_t *)&c->evtmsg_cstimeout)->offset = CCN_IRIBU_CONTENT_TIMEOUT * 1000UL; // ms
 ...
 */
static inline void ccn_iribu_riot_interest_remove(evtimer_t *et, struct ccn_iribu_interest_s *i)
{
