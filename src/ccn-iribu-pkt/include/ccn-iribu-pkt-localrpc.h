...
typedef int(rpcBuiltinFct)(struct ccn_iribu_relay_s *, struct ccn_iribu_face_s *,
                           struct rdr_ds_s *, struct rpc_exec_s *, struct rdr_ds_s *);
...
int ccn_iribu_rdr_getType(struct rdr_ds_s *ds);
...
int8_t ccn_iribu_rdr_getFlatLen(struct rdr_ds_s *ds, size_t *flatlen);
